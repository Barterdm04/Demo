...
declare module Insite.Cart.Services.Dtos {
	...
	interface PaymentOptionsDto {
		...
		creditCard: Insite.Plugins.PaymentGateway.Dtos.CreditCardDto;
...
declare module Insite.Plugins.PaymentGateway.Dtos {
...
declare module Insite.Catalog.WebApi.V1.ApiModels {
	...
	interface ProductCollectionModel extends Insite.Core.WebApi.BaseModel {
		...
		categoryFacets: InSite.Model.CategoryFacetDto[];
		attributeTypeFacets: InSite.Model.AttributeTypeFacetDto[];
		priceRange: InSite.Model.PriceRangeDto;
		exactMatch: boolean;
...
declare module InSite.Model {
	interface CategoryFacetDto {
		categoryId: System.Guid;
		shortDescription: string;
		count: number;
		selected: boolean;
		subCategoryDtos: InSite.Model.CategoryFacetDto[];
	}
	interface AttributeTypeFacetDto {
		...
		nameDisplay: string;
		sort: number;
		attributeValueFacets: InSite.Model.AttributeValueFacetDto[];
	}
	...
	interface PriceRangeDto {
		...
		maximumPrice: number;
		count: number;
		priceFacets: InSite.Model.PriceFacetDto[];
	}
