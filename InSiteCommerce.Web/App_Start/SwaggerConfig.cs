...
namespace InSiteCommerce.Web
{
    ...
    public class SwaggerConfig
    {
        ...
        {
            var thisAssembly = typeof(Insite.Swagger.Description).Assembly;
            ...
            GlobalConfiguration.Configuration.EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("v1", "InSiteCommerce.Web");
                    ...
                    c.GroupActionsBy(apiDesc => string.Join("/", apiDesc.Route.RouteTemplate.Split('/').Take(3)));
        ...
        private static List<string> GenerateProjectNames()
        {
            var xmlCommentsPath = string.Format(@"{0}\bin\xml\", AppDomain.CurrentDomain.BaseDirectory);
        ...
        {
            return string.Format(@"{0}\bin\xml\{1}", AppDomain.CurrentDomain.BaseDirectory, projectName);
        }
    }
}